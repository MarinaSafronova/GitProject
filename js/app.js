(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".swiper-stories")) new swiper_core_Swiper(".swiper-stories", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
    ...
    let el = document.getElementById("works-navbar__menu");
    if (window.innerWidth <= 991.98) ; else if (el) {
    ...
    const video = document.querySelectorAll(".custom-video__video");
    video.forEach((item => {
    ...
    let mybuttonTop = document.getElementById("mobile-watsapp");
    if (window.innerWidth <= 991.98) if (mybuttonTop) {
        ...
        function scrollFunction() {
            if (document.body.scrollTop > 50 || document.documentElement.scrollTop > 50) {
                ...
                mybuttonTop.classList.add("sticky-btn");
            } else mybuttonTop.classList.remove("sticky-btn");
        }
